                            ...
                            <form id="quickForm">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="fecha-solicitud"  class="form-control" id="fecha-solicitud" disabled value="<?php echo $fecha ;?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Link documento adjunto </label>
                                        <input type="text" name="link" class="form-control" id="link" placeholder="dd/mm/aa">
                                    </div>
