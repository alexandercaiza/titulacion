                                ...
                                <form id="quickForm">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="fecha-solicitud" id="fecha-solicitud" disabled class="form-control" value="<?php echo $fecha;  ?>" >
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Fecha de inicio</label>
                                            <input type="Date" name="fecha-inicio" id="fecha-inicio" class="form-control"  placeholder="dd/mm/aa">
                                        </div>
                                        <div class="form-group">
