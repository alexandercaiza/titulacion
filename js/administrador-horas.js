...
function actualizarHora(e) {
    if (e.target.parentElement.classList.contains('btn-aceptar')) {
        ...
        swal({
            ...
            if (result.value) {
                ...
                xhr.open('POST', '../inc/modelo/modelo-administrador-horas.php', true);
                xhr.onload = function() {
                    if (this.status === 200) {
                        /*  swal({
                              type: 'success',
                        ...
                        if (resultado == 'solicitud aceptada') {
                            ...
                            window.location.href = 'administrador-solicitud-horas.php?drfthu_45PIO=' + clienp + '&frft=' + ayuda + '&cuanto=' + cuanto;
    ...
    if (e.target.parentElement.classList.contains('btn-rechazar')) {
        ...
        const id = e.target.parentElement.getAttribute('data-id');
        const nom = e.target.parentElement.getAttribute('data-nom');
        const hora = e.target.parentElement.getAttribute('data-hora');
            ...
            if (result.value) {
                ...
                xhr.onload = function() {
                    if (this.status === 200) {
                        ...
                        var resultado = respuesta.respuesta
                        if (resultado == 'solicitud rechazada') {
