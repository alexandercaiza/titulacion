    ...
    if (e.target.parentElement.classList.contains('btn-aceptar')) {
        ...
        swal({
            ...
            if (result.value) {
                ...
                xhr.open('POST', '../inc/modelo/modelo-administrador-salud.php', true);
                xhr.onload = function() {
                    if (this.status === 200) {
                        /*  swal({
                              type: 'success',
                        ...
                        if (resultado == 'solicitud aceptada') {
                            ...
                            window.location.href = 'administrador-solicitud-salud.php?drfthu_45PIO=' + clienp + '&frft=' + ayuda + '&cuanto=' + cuanto;
    ...
    if (e.target.parentElement.classList.contains('btn-rechazar')) {
        ...
        swal({
            ...
            if (result.value) {
                ...
                console.log("El total de dias es " + total);
