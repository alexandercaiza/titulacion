        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Solicitudes por calamidad</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <thead>
                                        ...
                                        <tbody>
                                            <?php
                                          $calamidad = obtenerPermisoCalamidad();
                                          $v = array();
                                          foreach ($calamidad as $dat) {
                                              $v [] = $dat;
                                          }
                                          /*
                                          echo '<pre>';
                                          ...
                                          */
                                          ...
                                          if($calamidad->num_rows) { 
                                            ...
                                            foreach($calamidad as $contacto) { 
                                            if($contacto['perc_estado']=='proceso'){?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $contacto['perc_fecha_solicitud']; ?></td>
                                                <td><?php echo $contacto['perc_fecha_inicio']; ?></td>
                                                <td><?php echo $contacto['perc_fecha_fin']; ?></td>
                                                <!--enlace para el adjunto-->
                                                <td>
                                                    <a class="btn-down btn" target="_blank"
                                                        href="<?php echo $contacto['perc_adjunto']; ?>">
                                                ...
                                                <td>
                                                    <div class="btn btn-group">
                                                        ...
                                                        <button data-nom="<?php echo $contacto['per_apellidos']; ?>"
                                                            data-id="<?php echo $contacto['id_permiso_calamidad']; ?>"
                                                        ...
                                                        <button data-nom="<?php echo $contacto['per_apellidos']; ?>"
                                                            data-id="<?php echo $contacto['id_permiso_calamidad']; ?>"
                                                            data-cliente="<?php echo $contacto['id_persona_c']; ?>"
                                                            data-total="<?php echo $contacto['perc_dia_total']; ?>"
            ...
            <script src="../js/administrador-calamidad.js"></script>
