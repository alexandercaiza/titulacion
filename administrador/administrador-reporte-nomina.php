            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="ayuda-administrador.php?drfthu_45PIO=<?php echo $cliente+102020+3435; ?> &cuanto=<?php echo $tipo; ?>"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Ayuda</p>
                                    </a>
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                <th colspan="8" class="uno">INSTITUTO SUPERIOR TECNOLOGICO SUCRE</th>
                                                <br>
                                            </tr>
                                            <tr>
                                                <th colspan="8" class="dos">REPORTE DE INFORMACION DOCENTE</h2>
                                            </tr>
                                        ...
                                        <tbody>
                                        <?php
                                          $nomina = obtenerDatosNomina();
                                          $mes =Date('m');
                                          $vector_nomina = array();
                                          foreach ($nomina as $datos_nomina) {
                                              $vector_nomina [] = $datos_nomina;
                                          }
                                          /*
                                          
                                          echo '<pre>';
                                          var_dump( $vector_nomina);
                                          echo '</pre>';
                                          */
                                          ...
                                          if($nomina->num_rows) { 
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $mes ?></td>
                                                <td><?php echo $contacto['per_cedula']; ?></td>
                                                <td><?php echo $contacto['per_apellidos'].' '.$contacto['per_nombres']; ?></td>
                                                <td><?php echo (int)$contacto['sumar']; ?></td>
                                                <td><?php echo $contacto['per_puesto']; ?></td>
                                                
                                                <td><?php echo $contacto['per_instituto']; ?></td>
                                                <td><?php echo $contacto['per_observacion']; ?></td>
                                                
                                                <td><?php echo $contacto['per_correo']; ?></td>
