...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="../inicio-administrador.php?drfthu_45PIO=<?php echo $cliente+102020; ?> &cuanto=<?php echo $tipo+3435; ?> &cuanto=<?php echo $tipo; ?>" class="brand-link">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Agregar hora de vacación</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                                ...
                                <form id="quickForm">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Hora de vacación <small>(El valor decimal debe ir con una coma)</small> </label>
                                            <input type="text"  name="hora" class="form-control" id="hora" placeholder="Hora de vacación">
                                        </div>
        ...
        <script src="../js/cargar-hora.js"></script>
