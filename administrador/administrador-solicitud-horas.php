        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Solicitudes por horas</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                          $horas = obtenerPermisosHoras();
                                          $vector = array();
                                          foreach ($horas as $datos) {
                                              $vector [] = $datos;
                                          }
                                          /*
                                          echo '<pre>';
                                          ...
                                          */
                                          if($horas->num_rows) { 
                                            ...
                                            foreach($horas as $contacto) { 
                                            if($contacto['perh_estado']=='proceso'){?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $contacto['perh_fecha_inicio']; ?></td>
                                                <td><?php echo $contacto['perh_hora_inicio']; ?></td>
                                                <td><?php echo $contacto['perh_hora_final']; ?></td>
                                                <!--enlace para el adjunto-->
                                                <td>
                                                    <a class="btn-down btn" target="_blank"
                                                        href="<?php echo $contacto['perh_adjunto']; ?>">
                                                        <i class="fas fa-file-download"></i>
                                                    </a>

                                                </td>

                                                <td><?php echo $contacto['perh_observacion']; ?></td>
                                                ...
                                                <td>
                                                    <div class="btn btn-group">
                                                        ...
                                                        <button data-nom="<?php echo $contacto['per_apellidos']; ?>"
                                                            data-id="<?php echo $contacto['id_permiso_horas']; ?>"
                                                        ...
                                                        <button data-nom="<?php echo $contacto['per_apellidos']; ?>"
                                                            data-id="<?php echo $contacto['id_permiso_horas']; ?>"
                                                            data-cliente="<?php echo $contacto['id_persona_h']; ?>"
                                                            data-hora="<?php echo $contacto['perh_hora_total']; ?>"
            ...
            <script src="../js/administrador-horas.js"></script>
