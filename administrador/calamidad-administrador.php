...
<body class="hold-transition sidebar-mini">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                   <a href="../inicio-administrador.php?drfthu_45PIO=<?php echo $cliente+102020; ?> &cuanto=<?php echo $tipo+3435; ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                     <a href="restriccion-fecha.php?drfthu_45PIO=<?php echo $cliente+102020; ?> &cuanto=<?php echo $tipo+3435+3435; ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Fechas</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="cargar-hora.php?drfthu_45PIO=<?php echo $cliente+102020; ?> &cuanto=<?php echo $tipo+3435+3435; ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Cargar hora de vacación</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="actualizar-hora.php?drfthu_45PIO=<?php echo $cliente+102020; ?> &cuanto=<?php echo $tipo+3435+3435; ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="ayuda-administrador.php?drfthu_45PIO=<?php echo $cliente+102020; ?> &cuanto=<?php echo $tipo+3435+3435; ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Ayuda</p>
                                    </a>
                                </li>+3435+3435
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Permiso por calamidad</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                            ...
                            <form id="quickForm">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="fecha-solicitud" class="form-control" id="fecha-solicitud" value ="<?php echo $fecha_solicitud; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Fecha de inicio</label>
                                        <input type="Date" name="fecha-inicio" class="form-control" id="fecha-inicio" placeholder="día/mes/año">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Fecha de finalización</label>
                                        <input type="Date" name="fecha-final" class="form-control" id="fecha-final" placeholder="dd/mm/aa">
                                        <input type="hidden" id="cliente" value ="<?php echo $cliente; ?>" >
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Link para documento adjunto</label>
                                        <input type="text" name="link" class="form-control" id="link" placeholder="Aquí el link">
                                    </div>
    ...
    <script src="../js/docente-calamidad.js"></script>
