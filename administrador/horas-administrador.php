                                ...
                                <form id="quickForm">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="Date" name="fecha-solicitud" class="form-control"
                                                id="fecha-solicitud" placeholder="dd/mm/aa">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="concepto" class="form-control" rows="3"
                                                placeholder="Por motivo"></textarea>
                                        </div>
