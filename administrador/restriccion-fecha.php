               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="administrador-reporte-nomina.php?drfthu_45PIO=<?php echo $cliente+102020; ?> &cuanto=<?php echo $tipo; ?>"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Nómina</p>
                                    </a>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Restricción de la fecha</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                        ...
                        <div class="col-lg-6">
                            <div class="card card-primary">
                                ...
                                <div class="form-group">
                                            ...
                                            <input type="date" name="fecha" class="form-control" id="fecha" placeholder="Seleccione la fecha">
                                        </div>
                                    <!-- /.card-body -->
