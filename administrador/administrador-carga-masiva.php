...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Carga masiva docentes</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
            ...
            <!-- Main content AQUI SE AGREGA TODO EL CONTENIDO -->
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-6">
                                ...
                                <form action="files.php" method="post" enctype="multipart/form-data" id="filesForm" >
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Seleccione el archivo</label>
                                            <input type="file" name="fileContacts" class="form-control">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <button type="button" onclick="uploadContacts()" class="btn btn-primary" >Cargar</button>
                                    </div>
                                </form>
                            </div>
                            <!-- /.card -->
        ...
        <script src="../dist/js/pages/dashboard3.js"></script>
         <!-- SCRIPT PARA EL FUNCIONAMIENTO DEL SISTEMA -->
        <!-- <script src="../js/docente-asistencia.js"></script>-->
