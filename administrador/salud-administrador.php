...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                   <a href="../inicio-administrador.php?drfthu_45PIO=<?php echo $cliente+102020; ?>" class="nav-link">Inicio</a>
                </li>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Permiso por salud</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                                ...
                                <form id="quickForm">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="fecha-solicitud" class="form-control" id="fecha-solicitud" value="<?php echo $fecha_solicitud ?>" disabled  >
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Fecha de inicio</label>
                                            <input type="Date" name="fecha-inicio" class="form-control" id="fecha-inicio" placeholder="dd/mm/aa">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="link" class="form-control" id="link" placeholder="Aquí en el link">
        ...
        <script src="../js/docente-salud.js"></script>
